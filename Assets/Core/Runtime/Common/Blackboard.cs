...
namespace CrystalEngine
{
    ...
    public sealed class Blackboard
    {
        ...
        /// </summary>
        /// <typeparam name="T">Тип сохраняемых данных. / The type of data being stored.</typeparam>
        private static class Storage<T>
        {
            ...
            /// </summary>
            /// <param name="instance">Экземпляр доски данных Blackboard. / The Blackboard instance.</param>
            /// <returns>Словарь "ключ-значение" для хранения данных типа <typeparamref name="T"/>. / A key-value dictionary for storing data of type <typeparamref name="T"/>.</returns>
        ...
        /// </summary>
        /// <typeparam name="T">Тип записываемого значения. / The type of the value being set.</typeparam>
        /// <param name="key">Уникальный строковый идентификатор. / The unique string identifier.</param>
        /// <param name="value">Записываемое значение. / The value to store.</param>
        ...
        /// </summary>
        /// <typeparam name="T">Тип запрашиваемого значения. / The type of the value to retrieve.</typeparam>
        /// <param name="key">Уникальный строковый идентификатор. / The unique string identifier.</param>
        /// <param name="defaultValue">Значение, возвращаемое при отсутствии ключа. / The value returned if the key is not found.</param>
        /// <returns>Найденное значение или значение по умолчанию. / The retrieved value or the default value.</returns>
        ...
        /// </summary>
        /// <typeparam name="T">Тип проверяемого значения. / The type of the value to check.</typeparam>
        /// <param name="key">Уникальный строковый идентификатор. / The unique string identifier.</param>
        /// <returns>True, если ключ найден; иначе false. / True if the key is found; otherwise, false.</returns>
