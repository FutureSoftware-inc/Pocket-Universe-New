...
namespace CrystalEditor
{
    ...
    /// </summary>
    public sealed class GraphFileOperationsComponent : VisualComponent<VisualElement>
    {
        private readonly Action _onCreateAssetPressed;
        private readonly Action _onSaveGraphPressed;

        public GraphFileOperationsComponent(Action onCreateAssetPressed, Action onSaveGraphPressed)
        {
