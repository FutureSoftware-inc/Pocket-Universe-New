...
internal static class ErrorMessage
{
    ...
    internal static class ArgumentOutOfRange
    {
        ...
        // Добавьте вот эту строку для поддержки индексатора Deque:
        internal const string IndexMustBeLess =
    ...
    internal static class InvalidOperation
    {
        ...
        // Добавьте эту строку для Deque:
        internal const string EmptyDeque =
           "Deque empty.";
    }
